...
// import { useGetAllCardsQuery } from './actions/card.query';
...
//   const { data: apiResponse, isLoading, isError } = useGetAllCardsQuery();
//   const allProducts: Product[] = Array.isArray(apiResponse)
//     ? apiResponse
//     : apiResponse?.data || [];
